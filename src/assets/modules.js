export default {
  'Level 1 Solar Power': {
    constructionTime: '62 Hours',
    functions: [
      'Fuel consumption -50%',
    ],
    itemsRequired: {
      Military_power_filter: 4,
      Euros: 15000,
      Military_cable: 4,
      Phased_array_element: 2,
    },
    prevModules: {
      'Level 3 Generator': true,
      'Level 3 Workbench': true,
    },
    tradors: {
      Peacekeeper: 4,
    },
  ...
  'Level 3 Security': {
    ...
    prevModules: {
      'Level 2 Security': true,
      'Level 3 Illumination': true,
    },
    tradors: {
      Mechanic: 2,
    },
  ...
  'Level 3 Water Collector': {
    ...
    prevModules: {
      'Level 2 Water Collector': true,
      'Level 3 Generator': true,
      'Level 3 Heating': true,
    },
    tradors: {
      Jaeger: 3,
    },
  ...
  'Level 3 Intelligence Center': {
    ...
    prevModules: {
      'Level 3 Generator': true,
      'Level 2 Intelligence Center': true,
    },
    tradors: {
      Prapor: 3,
    },
  ...
  'Level 2 Rest Space': {
    ...
    prevModules: {
      'Level 2 Generator': true,
      'Level 2 Heating': true,
      'Level 1 Rest Space': true,
    },
    tradors: {
      Ragman: 2,
    },
  ...
  'Level 4 Stash': {
    ...
    prevModules: {
      ...
      'Level 3 Stash': true,
      'Level 3 Workbench': true,
      'Level 3 Intelligence Center': true,
      'Level 3 Heating': true,
    },
    tradors: {
      Ragman: 4,
    ...
    skills: null,
    gameType: 'EFT Edge of Darkness',
  },
  'Level 1 Water Collector': {
    constructionTime: '2 Hours',
    functions: [
  ...
  'Level 1 Booze Generator': {
    ...
    prevModules: {
      'Level 3 Water Collector': true,
      'Level 3 Nutrition Unit': true,
    },
    tradors: null,
    skills: null,
    gameType: null,
  ...
  'Level 2 Intelligence Center': {
    ...
    itemsRequired: {
      Folder_with_intelligence: 3,
      Secure_Flash_drive: 3,
      Damaged_hard_drive: 4,
      Powercord: 4,
    },
    prevModules: {
      'Level 3 Medstation': true,
      'Level 1 Intelligence Center': true,
      'Level 3 Security': true,
      'Level 3 Nutrition Unit': true,
    },
    tradors: {
  ...
  'Level 1 Stash': {
    ...
    tradors: null,
    skills: null,
    gameType: 'EFT Standard Edition',
  },
  'Level 1 Intelligence Center': {
    constructionTime: 'Instant',
    functions: [
  ...
  'Level 3 Stash': {
    ...
    skills: null,
    gameType: 'EFT Prepare for Escape',
  },
  'Level 3 Nutrition Unit': {
    ...
    itemsRequired: {
      Roubles: 125000,
      Coffee_Majaica: 3,
      Sodium_bicarbonate: 3,
    },
    prevModules: {
      'Level 2 Stash': true,
      'Level 2 Generator': true,
      'Level 2 Nutrition Unit': true,
      'Level 3 Lavatory': true,
    },
    tradors: null,
    skills: {
      Metabolism: '3',
  ...
  'Level 1 Scav Case': {
    ...
    functions: [
      ...
      '100 Roubles - 58m turnaround',
      '6000 Roubles - 2h 8m turnaround',
      '70000 Roubles - 2h 15m turnaround',
    ...
    itemsRequired: {
      ...
      Bronze_lion: 2,
      Gold_skull_ring: 2,
      Roler_submariner_gold_wrist_watch: 3,
    },
    prevModules: {
      'Level 2 Intelligence Center': true,
    },
  ...
  'Level 3 Bitcoin Farm': {
    ...
    prevModules: {
      'Level 2 Bitcoin Farm': true,
      'Level 1 Solar Power': true,
      'Level 3 Water Collector': true,
    },
    tradors: null,
    skills: null,
  ...
  'Level 2 Lavatory': {
    ...
    prevModules: {
      'Level 1 Lavatory': true,
      'Level 1 Water Collector': true,
    },
    tradors: null,
    skills: null,
    gameType: null,
  ...
  'Level 2 Nutrition Unit': {
    ...
    itemsRequired: {
      Corrugated_hose: 2,
      Wrench: 4,
      'Heat-exchange_alkali_surface_washer': 2,
      Phase_control_relay: 1,
    },
    prevModules: {
      'Level 2 Lavatory': true,
      'Level 1 Nutrition Unit': true,
    },
    tradors: null,
    skills: null,
    gameType: null,
